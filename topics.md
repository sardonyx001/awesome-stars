...
- [holon-run/holon](https://github.com/holon-run/holon) - An agent workbench for ongoing work: preserve goals and progress, connect events and schedules, and resume when the next condition is met.
